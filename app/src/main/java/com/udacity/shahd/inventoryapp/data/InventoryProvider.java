...
import com.udacity.shahd.inventoryapp.R;
...
public class InventoryProvider extends ContentProvider {
    ...
    static {
        ...
        sUriMatcher.addURI(InventoryContract.CONTENT_AUTHORITY, InventoryEntry.TABLE_NAME + "/#", PRODUCTS_ID);
    }
...
// return the new URI with the ID appended to the end of it
        ...
        // If the image is provided equal null
        String image = values.getAsString(InventoryEntry.COLUMN_PRODUCT_PICTURE);
    ...
    public int update(Uri uri, ContentValues contentValues, String selection,
        ...
        switch (match) {
            case PRODUCTS:
                return updateProducs(uri, contentValues, selection, selectionArgs);
            case PRODUCTS_ID:
     ...
     */
    private int updateProducs(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
